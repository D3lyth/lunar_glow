"""
Django settings for lunar_glow project.
...
SECRET_KEY = 'django-insecure-66e8+l+_oxu5_xg-))512$9oejj@k3pnwtj9gft3s_dqqb1pd#'
...
WSGI_APPLICATION = 'lunar_glow.wsgi.application'
